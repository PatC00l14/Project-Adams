...
shutil.copy(f'C:/Projects/Perry_run/Input_csv.csv', f'C:/Projects/Projects//{project_name}/Input_data/input_{pass_string}.csv')
shutil.copy(f'C:/Projects/Perry_run/XPythonPostProcessing.py' ,  f'C:/Projects/Projects/{project_name}/XPythonPostProcessing.py')
